...
CHECK:
    ...
    BTFSS ((INTCON) and 07Fh), 2 ;Contador sin botones
    goto $-1
    CALL REINICIO
    incf PORTB
 ...
 INCB: ;ANTIREBOTE INCREMENTO
  ...
  DECB:
   ...
   cuatrobits: ;Limita a 4 bits Puerto B
    movLW 16
    SUBwf PORTC, W
    BTFSC ((STATUS) and 07Fh), 2 ;Si la resta es 0 reinicia el puerto
    CLRF PORTC
    RETURN
...
TMR0_CONF: ; Configuracion del timer0
 ...
 REINICIO:
    ...
    BCF ((INTCON) and 07Fh), 2 ;Limpia bandera
    ReturN

ALARMA: ;subr. de alarma
    MOVF PORTC, 0
    SUBWF PORTB, W ;resta los valores
    BTFSC ((STATUS) and 07Fh), 2 ;verifica si es 0
    call INDICADOR
    return
